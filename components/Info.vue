<template>
  <div class="text-primary-50 flex flex-col items-center px-5 lg:px-20">
    <div class="flex flex-col items-center lg:flex-grow">
      <h1
        class="text-center mb-8 text-3xl font-bold tracking-tighter lg:text-5xl title-font"
      >
